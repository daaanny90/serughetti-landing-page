<script>
	...
	onMount(() => {
		wrapper.textContent = new Date().getFullYear();
	});
</script>
	...
	<div class="mx-auto max-w-7xl px-4 pt-16 pb-8 sm:px-6 lg:px-8 lg:pt-24">
			...
			<div class="grid grid-cols-2 gap-8 xl:col-span-2">
				<div class="md:grid md:grid-cols-2 md:gap-8">
					...
					<div class="mt-12 md:mt-0">
						...
						<ul role="list" class="mt-4 space-y-4">
							<li>
								<a href="#" class="text-base text-gray-500 hover:text-gray-900">Chi sono</a>
							</li>
				...
				<div class="md:grid md:grid-cols-2 md:gap-8">
					<div>
						<h3 class="text-base font-medium text-gray-900">Il mio metodo</h3>
						<ul role="list" class="mt-4 space-y-4">
							<li>
							...
							<li>
								<a href="#" class="text-base text-gray-500 hover:text-gray-900">powerlifting</a>
							</li>
						</ul>
					</div>
					<div class="mt-12 md:mt-0">
		...
		>
			...
			<p class="mt-8 text-base text-gray-400 md:order-1 md:mt-0">
				&copy; <span bind:this={wrapper} /> 1RM Powerlifting, Inc. All rights reserved.
			</p>
		</div>
	</div>
</footer>
