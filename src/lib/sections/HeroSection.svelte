				...
				<div class="relative shadow-xl sm:overflow-hidden sm:rounded-2xl">
					...
					<div class="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
						...
						<p class="mx-auto mt-6 max-w-lg text-center text-xl text-indigo-200 sm:max-w-3xl">
							Un allenamento dedicato alla prestazione per una crescita e un miglioramento fisico
							sano e naturale. L'allenamento come sfida contro se stessi, un approccio che aumenta
							la costanza dell'allenamento e garantisce risultati sia strutturali che estetici.
						</p>
						<div class="mx-auto mt-10 max-w-sm sm:flex sm:max-w-none sm:justify-center">
							<div class="space-y-4 sm:mx-auto sm:inline-grid sm:gap-5 sm:space-y-0">
								<a
									href="#"
